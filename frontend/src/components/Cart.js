...
const Cart = () => {
  ...
  return (
    <div>
    <div className="bg-grey-light rounded-3xl p-8 drop-shadow-md my-10 max-w-4xl mx-auto">
      <div className="overflow-x-auto">
        <table className="w-full">
          ...
          <tbody>
            {carts.map((cart) => (
              <tr key={cart.id} className="my-10">
                <td>
                ...
                <td className="px-4">{cart.bookName}</td>
                <td className="px-4">Price : <span className="font-bold">Rs.{cart.price}</span></td>
                <td className="px-4">Qty : <span className="font-bold">{cart.qty}</span></td>
                <td className="px-4">Rs.{cart.TotPrice}</td>
                <td>
